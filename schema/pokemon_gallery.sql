...
INSERT INTO `game` (`id`, `name`, `default_selection`)
VALUES (1, 'Go', false),
...
INSERT INTO `type` (`id`, `name`, `colour`, `border`)
VALUES (1, 'Normal', '#A8A878', '#6D6D4E'),
...
INSERT INTO `gender` (`id`, `name`, `short_name`, `suffix`)
VALUES (1, 'None/Unknown', null, null),
       (2, 'Male', '♂', null),
       (3, 'Female', '♀', '-f');
...
INSERT INTO `form` (`id`, `form_type_id`, `name`, `suffix`)
VALUES (1, 1, 'Original', NULL),
       (2, 1, 'Alolan', '-a'),
       (3, 1, 'Hisuian', '-h'),
       (4, 1, 'Galarian', '-g'),
       (5, 1, 'Paldean', '-p'),
...
INSERT INTO `form_suffix` (`id`, `name`)
VALUES (1, '-1'),
       (2, '-2'),
       (3, '-3'),
       (4, '-4'),
...
CREATE TABLE `pokemon` (
    ...
    `form_suffix_id` int(11)                                 NULL DEFAULT NULL,
...
INSERT INTO `pokemon` (`id`, `number`, `name`, `gender_id`, `form_id`, `form_suffix_id`, `type1`, `type2`)
VALUES (1, 1, 'Bulbasaur', 1, 1, NULL, 4, 8),
...
INSERT INTO `gallery` (`id`, `pokemon_id`, `datetime`, `filename`, `viewer`)
VALUES (1, 32, 1693854000, 'img/gallery/25.png', 'Aine_ni20'),
...
INSERT INTO `shiny` (`id`, `pokemon_id`, `game_id`, `caught_date`, `clip_url`)
VALUES (1, 5, 1, '2023-09-02', NULL),
       ...
       (33, 1199, 9, '2023-10-09', 'https://clips.twitch.tv/PeacefulVivaciousEagleLitFam-g1xKLpbEfiHefZ_U'),
       (34, 1196, 9, '2023-10-10', NULL),
       (35, 187, 11, '2019-11-21', NULL),
       (36, 1079, 12, '2020-07-01', NULL),
       (37, 842, 9, '2023-10-21', NULL),
       (38, 1013, 9, '2023-10-26', 'https://clips.twitch.tv/InterestingFilthyOilTriHard-l9ui0lMDwTWSBTgo'),
       (39, 1015, 9, '2023-10-26', 'https://clips.twitch.tv/DarlingDirtyCarabeefHassaanChop-e1efrV5J8hPYXs2K'),
       (40, 1014, 9, '2023-10-26', 'https://clips.twitch.tv/ProudUninterestedChamoisANELE-v7n-WU7CP0kxic7F');

ALTER TABLE `shiny` AUTO_INCREMENT = 41;
